...
export type ViewMode = 'home' | 'cards' | 'review' | 'play' | 'bricks' | 'bricks-challenge' | 'memory' | 'karaoke' | 'readers' | 'account' | 'teacher-materials' | 'english-coach' | 'install' | 'lesson-classify' | 'lesson-did-have' | 'past-trainer' | 'topic' | 'review-hub';
