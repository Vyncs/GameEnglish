...
const NAV_ITEMS = [
  ...
  { to: '/admin/financial', label: 'Financeiro', icon: DollarSign, end: false },
  { to: '/admin/traffic', label: 'Tráfego / Analytics', icon: BarChart3, end: false },
];
  ...
  return (
    <>
      <div className="flex items-center gap-3 mb-2 px-2">
        ...
        <div>
          <h2 className="font-bold text-slate-800 text-sm">Admin Panel</h2>
