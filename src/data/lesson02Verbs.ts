// Verbos 1–25 da folha "100 verbs" (arrive → eat).
//
// Cores da folha original, e é assim que o app mostra:
//   preto    = forma base
//   vermelho = passado simples — a forma que anda com DID
//   azul     = particípio — a forma que anda com HAVE
//   verde    = exemplo (mantidos exatamente como na folha da aula)
//
...
import { verbImg, withSentences, withFormSentences, type Topic } from './topic';
import { SENTENCES_VERBS_1 } from './sentencesVerbs1';
import { FORMS_VERBS_1 } from './formsVerbs1';
...
export const TOPIC_VERBS_1: Topic = {
  ...
  items: withFormSentences(withSentences([
    ...
    { id: 6, base: 'bring', past: 'brought', participle: 'brought', pt: 'trazer', example: 'Can you please bring me a glass?', irregular: true, rule: 'A', tip: 'Irregular: passado = particípio (brought). Serve para did e para have.' },
    ...
    { id: 9, base: 'can', past: 'could', pt: 'poder', example: 'Can I help you?', irregular: true, rule: 'C', tip: 'Regra C (modal: poder/saber/conseguir/dever). Passado: could. Não tem particípio — não existe "have could".' },
    ...
    { id: 11, base: 'clean', past: 'cleaned', participle: 'cleaned', pt: 'limpar', example: "It's not very clean.", irregular: false, rule: 'A', tip: 'Regular: clean → cleaned. A professora cita "wipe" como alternativa (limpar passando um pano).' },
    ...
    { id: 13, base: 'come', past: 'came', participle: 'come', pt: 'vir', example: 'Could you come earlier?', irregular: true, rule: 'A', tip: 'Irregular: come – came – come (o particípio volta a ser igual à base).' },
    ...
    { id: 16, base: 'cut', past: 'cut', participle: 'cut', pt: 'cortar', example: 'How did he cut his hand?', irregular: true, rule: 'A', tip: 'Irregular invariável: cut – cut – cut. As três formas são idênticas.' },
    ...
    { id: 19, base: 'depend on', past: 'depended on', participle: 'depended on', pt: 'depender', example: 'Do you depend on your parents?', irregular: false, rule: 'A', tip: 'Regular + preposição "on": depend ON. Sem o "on" a frase fica incompleta.' },
    ...
    { id: 21, base: 'do', past: 'did', participle: 'done', pt: 'fazer', example: 'What do you do?', irregular: true, rule: 'A', tip: 'Irregular: do – did – done. Também é o auxiliar da Regra A (do/does/did).' },
  ...
  ], SENTENCES_VERBS_1), FORMS_VERBS_1),
};
