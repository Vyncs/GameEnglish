...
export const TOPIC_VERBS_1: Topic = {
  ...
  items: [
    ...
    { id: 2, base: 'ask', past: 'asked', participle: 'asked', pt: 'pedir, perguntar, convidar', example: "Why don't you ask your father?", irregular: false, rule: 'A', tip: 'Regular: ask → asked.' },
    ...
    { id: 8, base: 'call', past: 'called', participle: 'called', pt: 'ligar, chamar', example: 'Call me later, please.', irregular: false, rule: 'A', tip: 'Regular: call → called.' },
    ...
    { id: 12, base: 'close', past: 'closed', participle: 'closed', pt: 'fechar, aproximar', example: 'Close the door, please.', irregular: false, rule: 'A', tip: 'Regular: close → closed.' },
    ...
    { id: 15, base: 'cry', past: 'cried', participle: 'cried', pt: 'chorar', example: 'Why was she crying again?', irregular: false, rule: 'A', tip: 'Regular com y → ied: cry → cried.' },
    ...
    { id: 19, base: 'depend on', past: 'depended on', participle: 'depended on', pt: 'depender de', example: 'Do you depend on your parents?', irregular: false, rule: 'A', tip: 'Regular + preposição "on": depend on.' },
    ...
    { id: 23, base: 'drink', past: 'drank', participle: 'drunk', pt: 'beber', example: 'Do you drink beer?', irregular: true, rule: 'A', tip: 'Irregular: drink – drank – drunk (i → a → u).' },
