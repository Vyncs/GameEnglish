...
export function CookieBanner() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[60] p-4 animate-fade-in">
      <div className="max-w-4xl mx-auto bg-surface rounded-2xl shadow-2xl border border-line p-5 sm:p-6">
        <div className="flex items-start gap-4">
          <div className="flex-1">
            <h3 className="text-sm font-semibold text-primary mb-1">Utilizamos cookies</h3>
          ...
          <button onClick={() => setVisible(false)} className="p-1 hover:bg-surface-2 rounded-lg transition-colors sm:hidden">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 mt-4">
          ...
          <button
            ...
            className="px-5 py-2 text-sm font-medium text-secondary bg-surface-2 rounded-xl hover:bg-surface-2 transition-colors"
          >
            Apenas essenciais
          </button>
        </div>
