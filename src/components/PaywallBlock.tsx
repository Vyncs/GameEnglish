...
export function PaywallBlock({ featureName }: PaywallBlockProps) {
  ...
  return (
    <div className="max-w-md mx-auto px-4 py-16">
      <div className="bg-surface backdrop-blur rounded-2xl shadow-xl border border-line p-8 text-center">
        <div className="w-16 h-16 rounded-full bg-amber-100 flex items-center justify-center mx-auto mb-4">
          <Lock className="w-8 h-8 text-amber-600" />
        </div>
        <h2 className="text-xl font-bold text-primary mb-2">Recurso exclusivo para assinantes</h2>
